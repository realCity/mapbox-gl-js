 ...
 * the cursor.
 * 
 * @param {DragPanOptions} [options]
 * @param {number} [inertiaMaxSpeed] Maximum speed (in pixel per seconds) of the inertial motion after the drag has ended 
 * @param {number} [inertiaDeceleration] Amount of speed loss per seconds after the drag has ended
 */
class DragPanHandler {
     ...
     * @private
     */
    constructor(map: Map, { clickTolerance = 1, dragPanOptions = defaultOptions }: MapOptions) {
        this._map = map;
